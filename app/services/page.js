...
const allServices = [
  {
    ...
    color: '#1A3C6E',
    items: [
      { icon: FiGlobe, title: 'Web Development', desc: 'Custom websites, eCommerce stores, and enterprise web apps built for performance.', href: '/services/web-development', price: 'From $499' },
      ...
      { icon: FiFileText, title: 'WordPress Development', desc: 'Powerful, easy-to-manage WordPress websites for businesses of all sizes.', href: '/services/wordpress-development', price: 'From $499' },
      { icon: FiSettings, title: 'Custom Web Applications', desc: 'SaaS platforms, portals, dashboards, and booking systems.', href: '/services/custom-web-applications', price: 'From $10,000' },
      { icon: FiSmartphone, title: 'Mobile App Development', desc: 'iOS, Android, and cross-platform apps built for performance and scale.', href: '/services/mobile-app-development', price: 'From $8,000' },
      ...
      { icon: FaAndroid, title: 'Android App Development', desc: 'Native Kotlin Android apps ready for Google Play.', href: '/services/android-app-development', price: 'From $8,000' },
      { icon: FiZap, title: 'Cross-Platform Apps', desc: 'React Native & Flutter apps for iOS + Android from one codebase.', href: '/services/cross-platform-apps', price: 'From $15,000' },
    ],
  },
  {
    ...
    color: '#27AE60',
    items: [
      { icon: FiSearch, title: 'SEO Services', desc: 'Complete SEO strategy: on-page, technical, content & link building.', href: '/services/seo', price: 'From $999/mo' },
      { icon: FiMapPin, title: 'Local SEO', desc: 'Dominate local search results and Google Maps in your city.', href: '/services/local-seo', price: 'From $499/mo' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: FiTag, title: 'Logo & Branding', desc: 'Logo, color palette, typography, and comprehensive brand guide.', href: '/services/logo-branding', price: 'From $49' },
      { icon: FiVideo, title: 'Video & Animation', desc: 'Explainer videos, motion graphics, and product demos.', href: '/services/video-animation', price: 'From $299' },
    ],
  },
  {
