...
const serviceData = {
  'ecommerce-development': {
    ...
    price: 'From $5,000',
    related: [{ title: 'eCommerce SEO', href: '/services/ecommerce-seo', icon: '🔍' }, { title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }],
  },
  'wordpress-development': {
    ...
    price: 'From $1,500',
    related: [{ title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'Web Hosting & Maintenance', href: '/services/hosting-maintenance', icon: '🖥️' }],
  },
  'custom-web-applications': {
    ...
    price: 'From $8,000',
    related: [{ title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'Mobile App Development', href: '/services/mobile-app-development', icon: '📱' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }],
  },
  'ios-app-development': {
    ...
    price: 'From $15,000',
    related: [{ title: 'Android App Development', href: '/services/android-app-development', icon: '🤖' }, { title: 'Cross-Platform Apps', href: '/services/cross-platform-apps', icon: '⚡' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }],
  },
  'android-app-development': {
    ...
    price: 'From $12,000',
    related: [{ title: 'iOS App Development', href: '/services/ios-app-development', icon: '🍎' }, { title: 'Cross-Platform Apps', href: '/services/cross-platform-apps', icon: '⚡' }, { title: 'Mobile App Development', href: '/services/mobile-app-development', icon: '📱' }],
  },
  'cross-platform-apps': {
    ...
    price: 'From $18,000',
    related: [{ title: 'iOS App Development', href: '/services/ios-app-development', icon: '🍎' }, { title: 'Android App Development', href: '/services/android-app-development', icon: '🤖' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }],
  },
  'local-seo': {
    title: 'Local SEO',
    ...
    related: [{ title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'Technical SEO', href: '/services/technical-seo', icon: '⚙️' }, { title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }],
  },
  'technical-seo': {
    title: 'Technical SEO',
    ...
    related: [{ title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'Local SEO', href: '/services/local-seo', icon: '📍' }, { title: 'Web Development', href: '/services/web-development', icon: '🌐' }],
  },
  'ecommerce-seo': {
    title: 'eCommerce SEO',
    ...
    related: [{ title: 'eCommerce Development', href: '/services/ecommerce-development', icon: '🛒' }, { title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }],
  },
  'social-media-marketing': {
    ...
    related: [{ title: 'PPC & Paid Advertising', href: '/services/ppc-advertising', icon: '💰' }, { title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }, { title: 'Graphic Design', href: '/services/graphic-design', icon: '✏️' }],
  },
  'ppc-advertising': {
    ...
    related: [{ title: 'Social Media Marketing', href: '/services/social-media-marketing', icon: '💬' }, { title: 'CRO', href: '/services/cro', icon: '📈' }, { title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }],
  },
  'content-marketing': {
    ...
    price: 'From $799/month',
    related: [{ title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'Social Media Marketing', href: '/services/social-media-marketing', icon: '💬' }, { title: 'Email Marketing', href: '/services/email-marketing', icon: '📧' }],
  },
  'ui-ux-design': {
    title: 'UI/UX Design',
    ...
    price: 'From $2,000',
    related: [{ title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'Mobile App Development', href: '/services/mobile-app-development', icon: '📱' }, { title: 'Graphic Design', href: '/services/graphic-design', icon: '✏️' }],
  },
  'graphic-design': {
    ...
    price: 'From $599/month',
    related: [{ title: 'Logo & Branding', href: '/services/logo-branding', icon: '🏷️' }, { title: 'Social Media Marketing', href: '/services/social-media-marketing', icon: '💬' }, { title: 'Video & Animation', href: '/services/video-animation', icon: '🎬' }],
  },
  'logo-branding': {
    title: 'Logo & Branding',
    ...
    price: 'From $800',
    related: [{ title: 'Graphic Design', href: '/services/graphic-design', icon: '✏️' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }, { title: 'Web Development', href: '/services/web-development', icon: '🌐' }],
  },
  'video-animation': {
    ...
    price: 'From $1,200',
    related: [{ title: 'Graphic Design', href: '/services/graphic-design', icon: '✏️' }, { title: 'Social Media Marketing', href: '/services/social-media-marketing', icon: '💬' }, { title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }],
  },
  'email-marketing': {
    ...
    related: [{ title: 'Content Marketing', href: '/services/content-marketing', icon: '📝' }, { title: 'CRO', href: '/services/cro', icon: '📈' }, { title: 'Social Media Marketing', href: '/services/social-media-marketing', icon: '💬' }],
  },
  'cro': {
    ...
    price: 'From $799/month',
    related: [{ title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'UI/UX Design', href: '/services/ui-ux-design', icon: '🎨' }, { title: 'SEO Services', href: '/services/seo', icon: '🔍' }],
  },
  'hosting-maintenance': {
    ...
    price: '$199/month',
    related: [{ title: 'Web Development', href: '/services/web-development', icon: '🌐' }, { title: 'Technical SEO', href: '/services/technical-seo', icon: '⚙️' }, { title: 'CRO', href: '/services/cro', icon: '📈' }],
  },
  'consulting': {
    ...
    price: 'From $200/hour',
    related: [{ title: 'SEO Services', href: '/services/seo', icon: '🔍' }, { title: 'PPC & Paid Advertising', href: '/services/ppc-advertising', icon: '💰' }, { title: 'CRO', href: '/services/cro', icon: '📈' }],
  },
};
      ...
      <section className="section">
        <div className="container">
          <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div style={{ background: 'var(--gradient-brand)', borderRadius: 24, padding: '3rem', textAlign: 'center', color: '#fff' }}>
              <div style={{ fontSize: '5rem', marginBottom: '1.5rem' }}>{data.icon}</div>
          ...
          <div className="grid-3">
            {data.related.map(r => (
              <Link key={r.href} href={r.href} className="card" style={{ textAlign: 'center', display: 'block' }}>
                ...
                <h3 style={{ fontSize: '1rem', color: 'var(--brand)' }}>{r.title}</h3>
              </Link>
            ))}
          </div>
        </div>
