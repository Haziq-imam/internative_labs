...
const serviceData = {
  ...
  'social-media-marketing': {
    ...
    mockup: '/images/social media.png',
  ...
  'ppc-advertising': {
    ...
    icon: FiDollarSign,
    mockup: '/images/ppc-advertizing.png',
  ...
  'graphic-design': {
    ...
    icon: FiPenTool,
    mockup: '/images/graphics-design.png',
  ...
  'logo-branding': {
    ...
    icon: FiTag,
    mockup: '/images/brand-identity.png',
  ...
  'video-animation': {
    ...
    icon: FiVideo,
    mockup: '/images/video-animation.png',
    ...
    <>
          ...
          <div className="hero-split">
            <div>
              <div className="hero-badge">
                <HeroIcon size={13} style={{ marginRight: 6, display: 'inline-block', verticalAlign: 'middle' }} />
                {data.title}
              </div>
              <h1 dangerouslySetInnerHTML={{ __html: data.hero.replace('<span>', '<span class="gradient-text">').replace('</span>', '</span>') }} />
            ...
            <div className="hero-visual">
              ...
              <div className="hero-image-frame" style={{ width: '100%', zIndex: 1, position: 'relative' }}>
                <div className="hero-browser-bar">
                  ...
                  <div className="hero-browser-url">internativelabs.com/services/{params.slug}</div>
                </div>
                <img
                  src={data.mockup || '/images/agency-dashboard.png'}
      ...
      <div style={{ background: 'var(--brand-dark)', padding: '30px 0' }}>
        <div className="container">
          <div className="service-stats-bar" style={{ display: 'flex', justifyContent: 'center', gap: '4rem', flexWrap: 'wrap' }}>
            {data.stats.map(([n, l]) => (
      ...
      <section className="section">
        <div className="container">
          <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div className="service-pricing-card" style={{ background: 'linear-gradient(135deg, var(--dark-2) 0%, var(--brand-dark) 100%)', border: '1.5px solid rgba(114,193,146,0.18)', borderRadius: 24, padding: '3rem', textAlign: 'center', color: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
