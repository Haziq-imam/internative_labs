      ...
      new TableRow({
        children: [
          new TableCell({
            ...
            children: [new Paragraph({ children: [new TextRun({ text: '🔍 SEO METADATA', bold: true, size: 22, color: WHITE, font: 'Arial' })] })]
          })
        ]
      }),
      ...
      new TableRow({
        children: [
          new TableCell({
            ...
            margins: { top: 80, bottom: 80, left: 150, right: 150 },
            children: [new Paragraph({ children: [new TextRun({ text: '🔗 INTERNAL LINKING OPPORTUNITIES', bold: true, size: 22, color: WHITE, font: 'Arial' })] })]
          })
        ]
      }),
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet('✓ 500+ Projects Delivered Across 20+ Industries'),
      bullet('✓ 97% Client Retention Rate'),
      bullet('✓ 10x Average ROI for Our Clients'),
      bullet('✓ Trusted by Businesses in 15+ Countries'),
      new Paragraph({ spacing: { before: 80 } }),
      ...
      new Table({
        ...
        rows: [
          new TableRow({
            children: [
              ['🎯 Results-Driven', '⚡ Fast Turnaround', '🔒 Transparent Pricing', '🤝 Long-Term Partner'].map(label =>
                new TableCell({
      ...
      signalCardTable([
        '🌐 Web Development — Custom websites, eCommerce stores, and web apps built for performance and conversions.',
        '📱 Mobile App Development — iOS, Android, and cross-platform apps that deliver exceptional user experiences.',
        '🔍 SEO Services — On-page, off-page, technical, and local SEO strategies that dominate search rankings.',
        '📣 Digital Marketing — PPC, social media, email marketing, and content strategies that generate qualified leads.',
        '🎨 Design & Branding — Logo design, UI/UX, brand identity, and creative services that make you stand out.',
        '📹 Video & Animation — Explainer videos, motion graphics, and product demos that engage and convert.',
      ]),

      new Paragraph({ spacing: { before: 160 } }),
      h2('SOCIAL PROOF SECTION'),
      body('Testimonials (3 Cards):', true),
      bullet('⭐⭐⭐⭐⭐ "InterNative Labs rebuilt our e-commerce store from scratch. Within 3 months, organic traffic increased by 180% and our conversion rate doubled." — James T., CEO, RetailEdge USA'),
      bullet('⭐⭐⭐⭐⭐ "They delivered our healthcare app ahead of schedule and the code quality is outstanding. Best tech partner we\'ve worked with." — Dr. Sarah M., MedConnect'),
      bullet('⭐⭐⭐⭐⭐ "Our Google rankings went from page 5 to position #2 for our most competitive keyword in 6 months. Incredible ROI." — Mark D., LawFirm Pro'),
      ...
      new Paragraph({ spacing: { before: 80 } }),
      body('Key Stats Banner:', true),
      bullet('✓ 300+ Websites Built Across All Industries'),
      bullet('✓ Average Page Load Time: Under 2 Seconds'),
      bullet('✓ 98% Client Satisfaction Rate'),
      bullet('✓ Mobile-First, SEO-Ready by Default'),
      new Paragraph({ spacing: { before: 80 } }),
      body('Primary CTA:', true),
      ...
      new Paragraph({ spacing: { before: 80 } }),
      bullet('✓ SEO-Optimized From Day One — Clean code, fast load times, proper schema markup, and mobile-first indexing built into every project'),
      bullet('✓ Conversion-Focused Design — Every element is strategically placed to guide visitors toward your primary conversion goal'),
      bullet('✓ Scalable Architecture — Built to grow with your business without costly rewrites or performance degradation'),
      bullet('✓ Security-First Approach — SSL, GDPR compliance, regular security audits, and vulnerability monitoring included'),
      bullet('✓ Ongoing Partnership — We don\'t disappear after launch. Monthly maintenance packages keep your site fast, secure, and updated'),
      ...
      new Paragraph({ spacing: { before: 80 } }),
      body('Key Stats Banner:', true),
      bullet('✓ 150+ Mobile Apps Shipped to App Store & Google Play'),
      bullet('✓ 4.8 Average App Store Rating Across All Published Apps'),
      bullet('✓ 99.9% Crash-Free Sessions'),
      bullet('✓ iOS, Android, React Native, Flutter'),
      new Paragraph({ spacing: { before: 80 } }),
      body('Primary CTA:', true),
      ...
      signalCardTable([
        '📱 Consumer Apps — B2C apps for iOS & Android including on-demand services, marketplaces, and lifestyle apps',
        '🏢 Enterprise Mobile Apps — Internal tools, field management, employee apps, and workflow automation',
        '🛒 mCommerce Apps — Mobile shopping experiences integrated with existing eCommerce platforms',
        '🏥 Healthcare Apps — HIPAA-compliant telemedicine, patient portals, and health tracking apps',
        '🚗 On-Demand Service Apps — Delivery, booking, and service marketplace apps with real-time tracking',
        '🎓 EdTech Apps — E-learning platforms, course delivery, quizzes, and progress tracking',
      ]),
      ...
      new Paragraph({ spacing: { before: 80 } }),
      body('Key Stats Banner:', true),
      bullet('✓ 92% of Clients Achieve Page 1 Rankings Within 6 Months'),
      bullet('✓ Average 187% Increase in Organic Traffic'),
      bullet('✓ 300+ Successful SEO Campaigns'),
      bullet('✓ White-Hat Only — Fully Google-Compliant Methods'),
      new Paragraph({ spacing: { before: 80 } }),
      body('Primary CTA:', true),
      ...
      signalCardTable([
        '🔍 On-Page SEO — Title tags, meta descriptions, header optimization, keyword mapping, internal linking structure, image alt text, schema markup',
        '⚙️ Technical SEO — Site speed optimization, Core Web Vitals, crawlability, indexation, XML sitemaps, canonical tags, HTTPS, mobile-first optimization',
        '📝 Content Strategy — Keyword research, content gap analysis, blog content creation, pillar pages, topic clusters, FAQ content',
        '🔗 Link Building — White-hat backlink acquisition, digital PR, guest posting, HARO outreach, local citations, competitor analysis',
        '📍 Local SEO — Google Business Profile optimization, local citations, NAP consistency, local keyword targeting, review generation',
        '📊 SEO Analytics & Reporting — Monthly rank tracking, traffic analysis, conversion attribution, competitor monitoring, ROI reporting',
      ]),
      ...
      body('🔒 30-Day Satisfaction Guarantee — If you\'re not fully satisfied with our work in the first 30 days, we\'ll make it right or refund your investment.'),
      ...
      bullet('✓ Technical SEO — Crawlability, indexation, sitemaps, robots.txt, canonical tags'),
      bullet('✓ Page Speed — Core Web Vitals scores, server response time, image optimization'),
      bullet('✓ Mobile Experience — Mobile-friendliness, tap targets, viewport configuration'),
      bullet('✓ On-Page SEO — Title tags, meta descriptions, header structure, keyword usage'),
      bullet('✓ Content Quality — Thin content, duplicate content, content gaps vs. competitors'),
      bullet('✓ Link Profile — Backlink quality, toxic links, internal linking structure'),
      bullet('✓ Conversion Elements — CTAs, forms, trust signals, friction points'),
      bullet('✓ Security — SSL certificate, HTTPS, security headers, vulnerability exposure'),
      new Paragraph({ spacing: { before: 80 } }),
      body('Primary CTA:', true),
      body('[Get My Free Website Audit — Takes 24 Hours]'),
      body('Trust Signals:', true),
      bullet('✓ No credit card required'),
      bullet('✓ Delivered within 24 business hours'),
      bullet('✓ Reviewed by a human expert (not just a tool report)'),
      bullet('✓ No obligation to purchase anything'),
      ...
      h2('OUR VALUES'),
      new Paragraph({ spacing: { before: 80 } }),
      bullet('🎯 Results Over Deliverables — We measure success in traffic, leads, and revenue. Not just lines of code or pages published.'),
      bullet('🔒 Radical Transparency — You\'ll always know what we\'re doing, why, and what results to expect. No black boxes, no fluff reports.'),
      bullet('⚡ Relentless Improvement — Markets change. We stay ahead of algorithm updates, emerging platforms, and new technologies so you don\'t have to.'),
      bullet('🤝 Partnership Mentality — We think of ourselves as your in-house digital team. Your success is our success.'),
      ...
      new Paragraph({ spacing: { before: 80 } }),
      body('📧 Email: info@internativelabs.com'),
      body('📞 Phone: +1 (888) 908-5040'),
      body('📍 Address: 811 Mason Grove Pkwy, Lawrenceville, GA 30043, USA'),
      body('🕐 Business Hours: Monday – Friday, 9:00 AM – 6:00 PM EST'),
      new Paragraph({ spacing: { before: 80 } }),
